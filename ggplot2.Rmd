...
<figure>
<embed src="images/data.svg" type="image/svg+xml" />
...
<embed src="images/pl1.svg" type="image/svg+xml" />

### add another variable using another axis
<embed src="images/pl3.svg" type="image/svg+xml" />

### encode a thrid variable using colour
<embed src="images/pl4.svg" type="image/svg+xml" />
...
<figure>
<embed src="images/data_types.svg" type="image/svg+xml" />
<figcaption>source: <a href="https://docs.google.com/presentation/d/10L-yA_Tq2-3r70F8EZHE0y5GCEE4214oJHucUclOhX8/edit#slide=id.g140a4aa7b2_1_0">Vega-Lite tutorial slides</a> by Dominik Moritz & Kanit “Ham” Wongsuphasawat
</figcaption>
</figure>
...
![](https://pagepiccinini.files.wordpress.com/2016/02/barplot_psa1.jpg) ![](https://ksr-ugc.imgix.net/assets/011/118/050/2a0e6672e417ed2a12fac1b1828d309a_original.png?w=680&fit=max&v=1462543835&auto=format&lossless=true&s=28a174592b91b6b590e0b35da3ade2a0)
...
```{r, density_simple}
pcPlot + geom_density(fill = "black") 
...
<figure>
<img src="images/visual-encoding.png"/>
<figcaption>source: <a href="https://docs.google.com/presentation/d/10L-yA_Tq2-3r70F8EZHE0y5GCEE4214oJHucUclOhX8/edit#slide=id.g140a4aa7b2_1_0">Vega-Lite tutorial slides</a> by Dominik Moritz & Kanit “Ham” Wongsuphasawat
</figcaption>
</figure>
...
pcPlot <- ggplot(patients_clean, aes(x=Height, y=Weight, colour=Sex, group = Sex))
